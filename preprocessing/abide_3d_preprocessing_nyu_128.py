"""
==============================================================================
ABIDE-I NYU Cohort 3D Multi-Planar Preprocessing (128x128 Benchmark Pipeline)
------------------------------------------------------------------------------
Author: Clint Loyed
Target Site: NYU Langone Medical Center (N=184 Subjects)
Target Resolution: (50, 128, 128, 1) 3D Volumetric Tensors

Features:
  1. AWS S3 Automatic Downloader for NYU Cohort
